...
export default class SignUpScreen extends Component {
  ...
  checkVariables = () => {
    alert(`ID: ${this.state.ID}, password: ${this.state.password}, male: ${this.state.male}, 
    female: ${this.state.female}, 
    cat: ${this.catList(this.state.cat1, this.state.cat2, this.state.cat3, this.state.cat4, this.state.cat5, this.state.cat6)} 
    age: ${this.state.age}`);
  }
